...
# dataset = AvazuDataset(dataset_path='/data/slwang/datasets/avazu/partition/data_results.csv', rebuild_cache=True, is_training=False)

# print(len(dataset))
# print(dataset.__getitem__(1)[0].shape)
# print(np.sum(dataset.field_dims))
