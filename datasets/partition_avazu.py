...
dataset_path = '/data/lygao/dataset/avazu/mini_set.csv'
device_id_partition_path = '/data/lygao/dataset/avazu/partition/device_id_partition.csv'
data_partition_path = '/data/lygao/dataset/avazu/partition/data_partition.csv'
device_id_data_path = '/data/lygao/dataset/avazu/partition/device_id_data.csv'
