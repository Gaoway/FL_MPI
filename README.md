...
``
mpiexec --oversubscribe -n 1 python server_main_q.py : -n 30 python client_main_q.py
mpiexec --oversubscribe -n 1 python server_main.py : -n 30 python client_main.py
``
